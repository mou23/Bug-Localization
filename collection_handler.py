...
def get_suspicious_files(project, bug_id, content):
    ...
    save_data_to_json(retrieved_documents, retrieved_metadatas, retrieved_distances, project+'_bug_data/'+ bug_id + '.json')
